...
#Enable Logging
LogFile<-paste(baseWD,"\\Log\\",currentTime_fName,"_Spanish_Long_Text_Mining_Scoring_v16.0_Log.txt",sep="")
zz_Log <- file(LogFile, open="wt")
sink(zz_Log, type = "message")

ListFile<-paste(baseWD,"\\Log\\",currentTime_fName,"_Spanish_Long_Text_Mining_Scoring_v16.0_List.txt",sep="")
...
code_name<-paste(baseWD,"\\Code\\Spanish_Long_Text_Mining_Scoring_v16.0.R",sep="")
code_description<-"Spanish Long Text"
...
# Read Target Data
ProductionTable_Spanish <- dbGetQuery(con, "select notification_number,long_text,asset,operation,commodity,commodity_identifier,notification_datetime
...
n_docs_with_termDB<- dbGetQuery(con, "select * from naturallanguageprocessing.t_n_docs_with_term where language='Spanish' and textlength='Long'")
...
ProductionTable_Spanish[,"long_text"]<-tolower(ProductionTable_Spanish[,"long_text"])
head(ProductionTable_Spanish)

#setwd(paste(baseWD,"\\Interim",sep=""))
#write.csv(ProductionTable_Spanish,"ProductionTable_Spanish.csv")

stringCleaned<-character(nrow(ProductionTable_Spanish))


for(i in 1:nrow(ProductionTable_Spanish)){
	string = ProductionTable_Spanish[i,"long_text"]
	strsplit1<-str_split(string,"~0a")[[1]]
	stringCleaned[i]<-paste(strsplit1[-grep("utc",strsplit1)],collapse=" ")
}

head(ProductionTable_Spanish[,"long_text"])
head(stringCleaned)
...
as.character(long_text1[[nrow(ProductionTable_Spanish)-2]])
as.character(long_text1[[nrow(ProductionTable_Spanish)-1]])
as.character(long_text1[[nrow(ProductionTable_Spanish)]])

#Remove strings identified above
...
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "immediate action taken", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "breve descripcin de lo ocurrido", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "secuencia bsica de eventos e", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "impactos, evitando nombrar a las personas involucradas", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "accin inmediata tomada", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "se crea aviso", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "enumere y describa los requerimientos del trabajo; incluyendo materiales", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "conocidos, labor y herramientas especializadas requeridas", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "identifique y explique cualquier restriccin del equipo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "repuestos se encuentran en patio fam", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "realizar trabajo con equipo bloqueado", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "incluya cualquier otra informacin que soporte los requerimientos del", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "mantener en observacion", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "mantener en observacion", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "actividades", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "descripcin", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "duracin", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "materiales", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "equipos auxiliares", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "req", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "especficos", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "recomendacin", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "recursos", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "adesviaciones", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "para este trabajo se requiere de", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "trabajo requerido", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "personal requerido", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "tcnicos", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "repuestos", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "descripcion del trabajo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "trabajo pendiente", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "instalar asien", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "en evaluacin", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "causa", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "solucin", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "sntoma", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "para ello se recomienda aplicar siguiente plan de accin prxima pm", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "recomienda", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "sintoma", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "recursos", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "mecanico", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "soldador", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "hora", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "pm", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "electrico", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "detalle de trabajo a realizar", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "solucion", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "trabajo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "equipo operativo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "mantencion", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "ejecutantes", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "falla encontrada", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "trabajo realizado", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "pendiente", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "continuar", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "atrabajo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "identifique y explique cualquier restriccin del equipo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "teléfono", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "apoyo", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "soporte", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "tripulación", " ", vectorize_all = FALSE))
long_text2 <- tm_map(long_text2, function(x) stri_replace_all_fixed(x, "inspección", " ", vectorize_all = FALSE))
...
as.character(long_text2[[nrow(ProductionTable_Spanish)-2]])
as.character(long_text2[[nrow(ProductionTable_Spanish)-1]])
as.character(long_text2[[nrow(ProductionTable_Spanish)]])
...
as.character(long_text3[[nrow(ProductionTable_Spanish)-2]])
as.character(long_text3[[nrow(ProductionTable_Spanish)-1]])
as.character(long_text3[[nrow(ProductionTable_Spanish)]])
...
as.character(long_text4[[nrow(ProductionTable_Spanish)-2]])
as.character(long_text4[[nrow(ProductionTable_Spanish)-1]])
as.character(long_text4[[nrow(ProductionTable_Spanish)]])


#Remove Stopwords
long_text5<- tm_map(long_text4, removeWords, stopwords("spanish"))
...
as.character(long_text5[[nrow(ProductionTable_Spanish)-2]])
as.character(long_text5[[nrow(ProductionTable_Spanish)-1]])
as.character(long_text5[[nrow(ProductionTable_Spanish)]])
...
ProductionTable_Spanish$notification_description<-df_notification_description$text
ProductionTable_Spanish<-ProductionTable_Spanish[,!(names(ProductionTable_Spanish) %in% "long_text")]
head(ProductionTable_Spanish)

#Get rid of multiple spaces
ProductionTable_Spanish$notification_description<-gsub('\\s+', ' ',ProductionTable_Spanish$notification_description)
head(ProductionTable_Spanish)
nrow(ProductionTable_Spanish)
names(ProductionTable_Spanish)
...
save(correctListTab,file=paste(currentTime_fName,"_ES_LONG__correctListTab.rda",sep=""))
}
...
setwd(paste(baseWD,"\\Backup",sep=""))
save(n_docs_with_termDB2,file=paste(currentTime_fName,"_ES_LONG_n_docs_with_termDB2.rda",sep=""))
...
##################
setwd(paste(baseWD,"\\Interim",sep=""))
save(outputFinal7,file="outputFinal7_Spanish_Long.rda")
...
#Delete
returnDelete2<-dbSendUpdate(con,"delete from naturallanguageprocessing.t_n_docs_with_term where language='Spanish' and textlength='Long';")
...
dbSendUpdate(con,"update common_tables.t_error_log
			set
			 ...
			 where code_description='Spanish Long Text'
			 and run_start_datetime=(select max(run_start_datetime) from common_tables.t_error_log where code_description='Spanish Long Text')")
dbCommit(con)
}
